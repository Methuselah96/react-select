...
cases(
  'should call onChange with `null` or [] on hitting backspace when backspaceRemovesValue is true',
  ({ props = { ...BASIC_PROPS }, expectedValue, expectedOnChangeValue }) => {
    let onChangeSpy = jest.fn();
    let { container } = render(
      <Select
        {...props}
